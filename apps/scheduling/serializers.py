...
class ScheduleDetailSerializer(serializers.ModelSerializer):
    ...
    proximity_warnings = serializers.SerializerMethodField()
    ...
    class Meta:
        ...
        fields = [
            ...
            'player_count', 'conflict_count', 'proximity_warnings',
            'created_at', 'updated_at',
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
    ...
    def get_proximity_warnings(self, obj):
        from .utils import detect_proximity_warnings_for_schedule
        return detect_proximity_warnings_for_schedule(obj)
