...
class ScheduleDetailSerializer(serializers.ModelSerializer):
    ...
    nearby_warnings = serializers.SerializerMethodField()
    ...
    class Meta:
        ...
        fields = [
            ...
            'player_count', 'conflict_count', 'nearby_warnings',
            'created_at', 'updated_at',
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
    ...
    def get_nearby_warnings(self, obj):
        from .utils import detect_nearby_sessions
        return detect_nearby_sessions(obj)
