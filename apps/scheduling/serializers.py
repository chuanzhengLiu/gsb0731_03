...
class ScheduleDetailSerializer(serializers.ModelSerializer):
    ...
    tight_schedule_warnings = serializers.SerializerMethodField()
    ...
    class Meta:
        ...
        fields = [
            ...
            'player_count', 'conflict_count', 'tight_schedule_warnings',
            'created_at', 'updated_at',
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
    ...
    def get_tight_schedule_warnings(self, obj):
        from .utils import get_tight_schedule_warnings
        return get_tight_schedule_warnings(obj)
